...
| `/speckit.verify`    | Verify implementation completeness: check all tasks done, deliverables present, execute TESTING.md CLI checks, and generate `VERIFICATION_REPORT.md` |
